...
How nice would it be to instead have the geo service intercept the data
initially sent to the Policy Generation Service based on the route taken so the
Policy Generation Service has all the data it needs in one smooth transfer.
